...
reports:
	...
	./commission-job.sh "Is this tweet talking about an important event?" "Summarize important events this week" "us-politics-commentators" "05-us-politics-commentators"
	...
	./commission-job.sh "Does this tweet refer to a significant event?" "Summarize significant events as captured by OSINT sources" "osint" "07-osint"
